                ...
                <table class="w-full text-sm text-left text-gray-700">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white/50 border-b border-gray-200/50">
                            ...
                            <td class="px-6 py-4"><?php echo htmlspecialchars($account['account_type']); ?></td>
                            <td class="px-6 py-4 text-right space-x-2">
                                <a href="edit_account.php?id=<?php echo $account['id']; ?>" class="font-medium text-indigo-600 hover:underline">Edit</a>
                                <a href="delete_account.php?id=<?php echo $account['id']; ?>" class="font-medium text-red-600 hover:underline" onclick="return confirm('Are you sure you want to delete this account? This cannot be undone.');">Delete</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
