...
<div class="glass-card p-8">
    ...
    <form action="add-user.php" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="flex justify-end pt-6 border-t border-gray-200/50">
            <button type="button" onclick="window.location.href='../users/'" class="bg-white/80 py-2 px-4 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50/50">
                Cancel
            </button>
