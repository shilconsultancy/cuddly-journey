<?php
// pos/sale.php (Previously index.php)
        ...
        <div class="lg:col-span-1 bg-white/60 p-4 rounded-xl flex flex-col">
             <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex space-x-2">
                    <a href="index.php" class="text-sm bg-gray-500 text-white px-3 py-1 rounded-lg hover:bg-gray-600">&larr; Back to POS Menu</a>
                    <a href="close-session.php" class="text-sm bg-red-500 text-white px-3 py-1 rounded-lg hover:bg-red-600">End Session</a>
                </div>
            </div>
