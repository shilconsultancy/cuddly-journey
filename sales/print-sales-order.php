...
$order_stmt = $conn->prepare("
    SELECT so.*, c.customer_name, c.address as customer_address, ct.contact_name
...
$page_title = "Print Order: " . htmlspecialchars($order['order_number']);
    ...
    <div class="invoice-box">
        <header class="header">
            ...
            <div class="header-right">
                ...
                <p>
                    ...
                    <strong>Date:</strong> <?php echo date($app_config['date_format'], strtotime($order['order_date'])); ?>
                </p>
            </div>
        </header>
        ...
        <section class="addresses">
            ...
            <div class="address-block">
                ...
                <p>
                    ...
                    <?php if(!empty($order['contact_name'])) echo htmlspecialchars($order['contact_name']) . '<br>'; ?>
        ...
        <section class="totals-section">
            <table class="totals-table">
                <tr>
                    <td>Subtotal:</td>
                    <td class="text-right"><?php echo $currency_symbol . htmlspecialchars(number_format($order['subtotal'], 2)); ?></td>
                </tr>
                <tr>
                    <td>Tax (0%):</td>
                    <td class="text-right"><?php echo $currency_symbol . htmlspecialchars(number_format($order['tax_amount'], 2)); ?></td>
                </tr>
                <tr class="grand-total">
                    <td>Grand Total:</td>
                    <td class="text-right"><?php echo $currency_symbol . htmlspecialchars(number_format($order['total_amount'], 2)); ?></td>
                </tr>
            </table>
        </section>
